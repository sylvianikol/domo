...
import com.syn.domo.exception.error.ErrorResponse;
...
public class ExceptionHandlerAdvice {
    ...
    @ResponseBody
    public ErrorResponse handleBuildingNotFoundException(DomoEntityNotFoundException ex, WebRequest request) {
